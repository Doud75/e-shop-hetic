...
<div class="mx-auto w-10/12">
    ...
    <form on:submit={handleSubmit}>
        <div class="h-[95vh] flex-col flex justify-center">
            ...
            <input id="email" type="email" required bind:value={email} placeholder="Adresse e-mail" class="rounded-lg w-full border-2 py-1 px-2 mb-4">
            <input id="password" type="password" required bind:value={password} placeholder="Mot de passe" class="rounded-lg border-2 w-full py-1 px-2">
        </div>
